...
moderna. El sistema de Morgan--Keenan (MK) ordena a las estrellas en una
...
acervo: un conjunto curado de \num{498} estrellas de Gaia DR3, con su
...
con corpus especializados. En astronomía, modelos como \AstroSage{} (un LLM de
...
% TODO: cita formal de Gaia DR3 (Gaia Collaboration et al. 2023) en referencias.bib
% TODO: cita formal del sistema MK (Morgan, Keenan \& Kellman 1943)
% TODO: cita formal de AstroSage-8B (pendiente verificar referencia exacta)
